...
<head>
    ...
    <title>Sport Yo - Usuário não encontrado</title>
</head>
<header>
    <div id="container">
        <div class="logo">
...
<body>
    ...
    <div id="contents">
        <h1><i class="fas fa-times"></i> Usuário ou senha incorretos!</h1>
        <h2>Verifique se digitou corretamente as credenciais e tente novamente.</h2>
        <button class="goback">
            <p>
